...
// .svelte-kit/output/server/chunks/index-498d9a7e.js
function noop2() {
}
function run(fn) {
  return fn();
...
var getStores, page, css$1, Header, css, _layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    ...
    css$1 = {
      code: "header.svelte-1hdypxq.svelte-1hdypxq{display:flex;justify-content:space-between}.corner.svelte-1hdypxq.svelte-1hdypxq{width:3em;height:3em}nav.svelte-1hdypxq.svelte-1hdypxq{display:flex;justify-content:center;--background:var(--bg-secondary-color)}svg.svelte-1hdypxq.svelte-1hdypxq{width:2em;height:3em;display:block}path.svelte-1hdypxq.svelte-1hdypxq{fill:var(--background)}ul.svelte-1hdypxq.svelte-1hdypxq{position:relative;padding:0;margin:0;height:3em;display:flex;justify-content:center;align-items:center;list-style:none;background:var(--background);background-size:contain}li.svelte-1hdypxq.svelte-1hdypxq{position:relative;height:100%}li.active.svelte-1hdypxq.svelte-1hdypxq::before{--size:6px;content:'';width:0;height:0;position:absolute;top:0;left:calc(50% - var(--size));border:var(--size) solid transparent;border-top:var(--size) solid var(--accent-color)}nav.svelte-1hdypxq a.svelte-1hdypxq{display:flex;height:100%;align-items:center;padding:0 1em;color:var(--heading-color);font-weight:700;font-size:0.8rem;text-transform:uppercase;letter-spacing:0.1em;text-decoration:none;transition:color 0.2s linear}a.svelte-1hdypxq.svelte-1hdypxq:hover{color:var(--accent-color);text-shadow:#fff !important}",
      map: null
    };
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_page();
      return `<header class="${"svelte-1hdypxq"}"><div class="${"corner svelte-1hdypxq"}"></div>

	<nav class="${"svelte-1hdypxq"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1hdypxq"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-1hdypxq"}"></path></svg>
		<ul class="${"svelte-1hdypxq"}"><li class="${["svelte-1hdypxq", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1hdypxq"}">Home</a></li>
			<li class="${["svelte-1hdypxq", $page.url.pathname === "/activity" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/activity"}" class="${"svelte-1hdypxq"}">Activity</a></li></ul>
		<svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1hdypxq"}"><path d="${"M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z"}" class="${"svelte-1hdypxq"}"></path></svg></nav>

	<div class="${"corner svelte-1hdypxq"}"></div>
</header>`;
    });
    css = {
      code: "main.svelte-ne3gu9{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;margin:0 auto;box-sizing:border-box}@media screen and (min-width: 1024px){main.svelte-ne3gu9{max-width:85%}}@media screen and (max-width: 1024px){main.svelte-ne3gu9{max-width:90%}}@media screen and (max-width: 992px){main.svelte-ne3gu9{max-width:95%}}@media screen and (max-width: 899px){main.svelte-ne3gu9{max-width:100%}}",
      map: null
    };
...
<main class="${"svelte-ne3gu9"}">${slots.default ? slots.default({}) : ``}
</main>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-d7f66ee2.js";
    js = ["pages/__layout.svelte-d7f66ee2.js", "chunks/index-c16f7798.js"];
    css2 = ["assets/pages/__layout.svelte-545125e0.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "error.svelte-d4b818d3.js";
    js2 = ["error.svelte-d4b818d3.js", "chunks/index-c16f7798.js"];
    css3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/activity.svelte.js
var activity_svelte_exports = {};
__export(activity_svelte_exports, {
  default: () => Activity
});
var css$7, Timeline, css$6, TimelineItem, css$5, TimelineSeparator, css$4, TimelineDot, css$3, TimelineConnector, css$2, TimelineContent, css$12, TimelineOppositeContent, css4, Activity;
var init_activity_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/activity.svelte.js"() {
    init_index_498d9a7e();
    css$7 = {
    ...
    TimelineItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<li class="${escape(null_to_empty(`timeline-item ${itemPosition}`)) + " svelte-77d8h8"}"${add_attribute("style", style, 0)}>${!$$slots["opposite-content"] ? `<div class="${"opposite-block svelte-77d8h8"}"></div>` : `${slots["opposite-content"] ? slots["opposite-content"]({}) : ``}`}
    ...
    TimelineSeparator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { style = null } = $$props;
      if ($$props.style === void 0 && $$bindings.style && style !== void 0)
        $$bindings.style(style);
    ...
    css$4 = {
      code: ".timeline-dot.svelte-6isv2c{background-color:#121212;border:solid 3px #121212;display:flex;align-self:baseline;padding:8px;border-radius:50%;margin:11.5px 0}@media screen and (min-width: 1024px){.timeline-dot.svelte-6isv2c{padding:12px}}@media screen and (max-width: 1024px){.timeline-dot.svelte-6isv2c{padding:10px}}@media screen and (max-width: 992px){.timeline-dot.svelte-6isv2c{padding:8px}}@media screen and (max-width: 499px){.timeline-dot.svelte-6isv2c{padding:6px}}",
      map: null
    };
    TimelineDot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { style = null } = $$props;
      if ($$props.style === void 0 && $$bindings.style && style !== void 0)
        $$bindings.style(style);
      $$result.css.add(css$4);
      return `<span class="${"timeline-dot svelte-6isv2c"}"${add_attribute("style", style, 0)}>${slots.default ? slots.default({}) : ``}
</span>`;
    });
    css$3 = {
    ...
    TimelineConnector = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { style = null } = $$props;
      if ($$props.style === void 0 && $$bindings.style && style !== void 0)
        $$bindings.style(style);
    ...
    TimelineContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { style = null } = $$props;
      const config = getContext("TimelineConfig");
      ...
      return `<div class="${escape(null_to_empty(`timeline-content ${itemPosition}`)) + " svelte-ov1kt8"}"${add_attribute("style", style, 0)}>${slots.default ? slots.default({}) : ``}
</div>`;
    });
    css$12 = {
    ...
    TimelineOppositeContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { style = null } = $$props;
      const config = getContext("TimelineConfig");
      const parentPosition = getContext("ParentPosition");
      const itemPosition = parentPosition ? parentPosition : config.rootPosition;
      ...
      return `<div class="${escape(null_to_empty(`timeline-opposite-content ${itemPosition}`)) + " svelte-r6jwvl"}"${add_attribute("style", style, 0)}>${slots.default ? slots.default({}) : ``}
</div>`;
    });
    css4 = {
      code: ".oposite-content-title.svelte-1m5pl1e{margin:0;padding:0}.content-title.svelte-1m5pl1e{margin:0;padding:0}.content-description.svelte-1m5pl1e{margin:0;padding:0;color:#d1d3dd;font-weight:lighter;padding:0.5rem 0}.content-img.svelte-1m5pl1e{padding-top:0.5rem}",
      map: null
    };
    Activity = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const colors = ["#7CD5E2", "#FEC048", "#DD84C1", "#FB6958"];
      const items = [
        {
          index: 1,
          year: "October, 2018",
          title: "Moddang Bootcamp 2018",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E1A\u0E23\u0E21\u0E41\u0E25\u0E30\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19 MODDANG: Boot Camp, Real-World Data Science Challenges, Thailand, 2018.",
          imgSrc: "1_4-MOD-1.jpg"
        },
        {
          index: 2,
          year: "November, 2018",
          title: "The 2018 ICPC Asia Bangkok Programming Contest",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E01\u0E32\u0E23\u0E40\u0E02\u0E35\u0E22\u0E19\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21 The 2018 ICPC Asia Bangkok Programming Contest, at (ICT) Mahidol University",
          imgSrc: "1_1-icpc.jpeg"
        },
        {
          index: 3,
          year: "February, 2019",
          title: "National Software Contest (NSC) 2019",
          description: "\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21\u0E04\u0E2D\u0E21\u0E1E\u0E34\u0E27\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E41\u0E2B\u0E48\u0E07\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22 \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 21 (NSC2019)",
          imgSrc: "1_2-nsc.jpg"
        },
        {
          index: 4,
          year: "August, 2019",
          title: "Raspberry Pi Programming for Investigation 2019",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E2D\u0E1A\u0E23\u0E21 Raspberry Pi Programming for Investigation at Chiang Rai",
          imgSrc: "1_5-RaspPi.jpeg"
        },
        {
          index: 5,
          year: "October, 2019",
          title: "2019 IEEE 8th Global Conference on Consumer Electronics (GCCE)",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E19\u0E33\u0E40\u0E2A\u0E19\u0E2D\u0E1C\u0E25\u0E07\u0E32\u0E19 \u0E43\u0E19\u0E07\u0E32\u0E19 Global Conference on Consumer Electronics (GCCE) \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 8 \u0E13 \u0E42\u0E2D\u0E0B\u0E32\u0E01\u0E49\u0E32, \u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E0D\u0E35\u0E48\u0E1B\u0E38\u0E48\u0E19",
          imgSrc: "1_3-GCCE-2.JPG"
        },
        {
          index: 6,
          year: "November, 2019",
          title: "The 2019 ICPC Asia Bangkok Programming Contest, at (ENG) Chulalongkorn University.",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E01\u0E32\u0E23\u0E40\u0E02\u0E35\u0E22\u0E19\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21 The 2019 ICPC Asia Bangkok Programming Contest, at (ENG) Chulalongkorn University.",
          imgSrc: "2_1-icpc.jpg"
        },
        {
          index: 7,
          year: "February, 2020",
          title: "National Software Contest (NSC) 2020",
          description: "\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21\u0E04\u0E2D\u0E21\u0E1E\u0E34\u0E27\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E41\u0E2B\u0E48\u0E07\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22 \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 22 (NSC2020)",
          imgSrc: "2_2-nsc.jpg"
        },
        {
          index: 8,
          ...
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E2D\u0E1A\u0E23\u0E21 MODDANG: Boot Camp, Real-World Data Science Challenges, Thailand, 2020.",
          imgSrc: "2_3-MOD-2.jpg"
        },
        {
          index: 9,
          year: "October, 2020",
          title: "the 2020 APAC HPC-AI Competition",
          description: "\u0E01\u0E32\u0E23\u0E2D\u0E1A\u0E23\u0E21\u0E41\u0E25\u0E30\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E40\u0E23\u0E48\u0E07\u0E01\u0E33\u0E25\u0E31\u0E07\u0E42\u0E21\u0E40\u0E14\u0E25\u0E1B\u0E31\u0E0D\u0E0D\u0E32\u0E1B\u0E23\u0E30\u0E14\u0E34\u0E29\u0E10\u0E4C\u0E1A\u0E19\u0E23\u0E30\u0E1A\u0E1A\u0E1B\u0E23\u0E30\u0E21\u0E27\u0E25\u0E1C\u0E25\u0E2A\u0E21\u0E23\u0E23\u0E16\u0E19\u0E30\u0E2A\u0E39\u0E07 \u0E40\u0E2D\u0E0A\u0E1E\u0E35\u0E0B\u0E35-\u0E40\u0E2D\u0E44\u0E2D \u0E41\u0E2B\u0E48\u0E07\u0E20\u0E39\u0E21\u0E34\u0E20\u0E32\u0E04\u0E40\u0E2D\u0E40\u0E0A\u0E35\u0E22\u0E41\u0E1B\u0E0B\u0E34\u0E1F\u0E34\u0E01 (2020 APAC HPC-AI)",
          imgSrc: "3_1-hpcai.jpg"
        },
        {
          index: 10,
          year: "February, 2021",
          title: "National Software Contest (NSC) 2021",
          description: "\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21\u0E04\u0E2D\u0E21\u0E1E\u0E34\u0E27\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E41\u0E2B\u0E48\u0E07\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22 \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 23 (NSC2021)",
          imgSrc: "3_2-nsc.jpg"
        },
        {
          index: 11,
          year: "July, 2021",
          title: "The 9th Asia Undergraduate Conference on Computing : AUCC2021",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E19\u0E33\u0E40\u0E2A\u0E19\u0E2D\u0E1C\u0E25\u0E07\u0E32\u0E19\u0E27\u0E34\u0E0A\u0E32\u0E01\u0E32\u0E23 \u0E41\u0E25\u0E30\u0E44\u0E14\u0E49\u0E23\u0E31\u0E1A\u0E23\u0E32\u0E07\u0E27\u0E31\u0E25\u0E1C\u0E25\u0E07\u0E32\u0E19\u0E27\u0E34\u0E08\u0E31\u0E22\u0E43\u0E19\u0E01\u0E32\u0E23\u0E1B\u0E23\u0E30\u0E0A\u0E38\u0E21\u0E27\u0E34\u0E0A\u0E32\u0E01\u0E32\u0E23\u0E23\u0E30\u0E14\u0E31\u0E1A\u0E1B\u0E23\u0E34\u0E0D\u0E0D\u0E32\u0E15\u0E23\u0E35\u0E14\u0E49\u0E32\u0E19\u0E04\u0E2D\u0E21\u0E1E\u0E34\u0E27\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E20\u0E39\u0E21\u0E34\u0E20\u0E32\u0E04\u0E40\u0E2D\u0E40\u0E0A\u0E35\u0E22 \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 9 (The 9th Asia Undergraduate Conference on Computing : AUCC2021)",
          imgSrc: "3_3-aucc.jpg"
        },
        {
          index: 12,
          year: "October, 2021",
          title: "Thailand Machine Learning for Chemistry (TMLCC)",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E42\u0E04\u0E23\u0E07\u0E01\u0E32\u0E23 Thailand Machine Learning for Chemistry (TMLCC)",
          imgSrc: "4_1-TMLCC.jpg"
        },
        {
          index: 13,
          year: "November, 2021",
          title: "Thailand Research Expo 2021",
          description: "\u0E40\u0E02\u0E49\u0E32\u0E23\u0E48\u0E27\u0E21\u0E01\u0E34\u0E08\u0E01\u0E23\u0E23\u0E21\u0E01\u0E32\u0E23\u0E1B\u0E23\u0E30\u0E01\u0E27\u0E14\u0E1C\u0E25\u0E07\u0E32\u0E19\u0E19\u0E27\u0E31\u0E15\u0E01\u0E23\u0E23\u0E21\u0E2A\u0E32\u0E22\u0E2D\u0E38\u0E14\u0E21\u0E28\u0E36\u0E01\u0E29\u0E32 \u0E1B\u0E23\u0E30\u0E08\u0E33\u0E1B\u0E35 2564 \u0E43\u0E19\u0E07\u0E32\u0E19 \u201C\u0E21\u0E2B\u0E01\u0E23\u0E23\u0E21\u0E07\u0E32\u0E19\u0E27\u0E34\u0E08\u0E31\u0E22\u0E41\u0E2B\u0E48\u0E07\u0E0A\u0E32\u0E15\u0E34 2564 (Thailand Research Expo 2021)\u201D \u0E42\u0E14\u0E22 \u0E2A\u0E33\u0E19\u0E31\u0E01\u0E07\u0E32\u0E19\u0E01\u0E32\u0E23\u0E27\u0E34\u0E08\u0E31\u0E22\u0E41\u0E2B\u0E48\u0E07\u0E0A\u0E32\u0E15\u0E34 (\u0E27\u0E0A.)",
          imgSrc: "4_2-tr-expo-2.jpg"
        },
        {
          index: 14,
          year: "November, 2021",
          title: "The 4th APAC HPC-AI 2021",
          description: "\u2B50 \u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E40\u0E23\u0E48\u0E07\u0E01\u0E33\u0E25\u0E31\u0E07\u0E42\u0E21\u0E40\u0E14\u0E25\u0E1B\u0E31\u0E0D\u0E0D\u0E32\u0E1B\u0E23\u0E30\u0E14\u0E34\u0E29\u0E10\u0E4C\u0E1A\u0E19\u0E23\u0E30\u0E1A\u0E1A\u0E1B\u0E23\u0E30\u0E21\u0E27\u0E25\u0E1C\u0E25\u0E2A\u0E21\u0E23\u0E23\u0E16\u0E19\u0E30\u0E2A\u0E39\u0E07 \u0E40\u0E2D\u0E0A\u0E1E\u0E35\u0E0B\u0E35-\u0E40\u0E2D\u0E44\u0E2D \u0E41\u0E2B\u0E48\u0E07\u0E20\u0E39\u0E21\u0E34\u0E20\u0E32\u0E04\u0E40\u0E2D\u0E40\u0E0A\u0E35\u0E22\u0E41\u0E1B\u0E0B\u0E34\u0E1F\u0E34\u0E01 (The 4th APAC HPC-AI 2021)",
          imgSrc: "4_3-hpcai-1.JPG"
        },
        {
          index: 15,
          year: "February, 2022",
          title: "National Software Contest (NSC) 2022",
          description: "\u2B50 \u0E01\u0E32\u0E23\u0E41\u0E02\u0E48\u0E07\u0E02\u0E31\u0E19\u0E1E\u0E31\u0E12\u0E19\u0E32\u0E42\u0E1B\u0E23\u0E41\u0E01\u0E23\u0E21\u0E04\u0E2D\u0E21\u0E1E\u0E34\u0E27\u0E40\u0E15\u0E2D\u0E23\u0E4C\u0E41\u0E2B\u0E48\u0E07\u0E1B\u0E23\u0E30\u0E40\u0E17\u0E28\u0E44\u0E17\u0E22 \u0E04\u0E23\u0E31\u0E49\u0E07\u0E17\u0E35\u0E48 24 (NSC2022)",
          imgSrc: "4_4-nsc.jpg"
        }
      ];
      $$result.css.add(css4);
        ...
        default: () => {
          return `${each(items, (item) => {
            return `${validate_component(TimelineItem, "TimelineItem").$$render($$result, {}, {}, {
              "opposite-content": () => {
                return `${validate_component(TimelineOppositeContent, "TimelineOppositeContent").$$render($$result, { slot: "opposite-content" }, {}, {
                  default: () => {
                    return `<p class="${"oposite-content-title svelte-1m5pl1e"}">${escape(item.year)}</p>
			`;
                  }
                })}`;
              },
              default: () => {
                return `${validate_component(TimelineSeparator, "TimelineSeparator").$$render($$result, {}, {}, {
                  default: () => {
                    return `${validate_component(TimelineDot, "TimelineDot").$$render($$result, {
                      style: `background-color: ${colors[(item.index - 1) % colors.length]}; border-color: #fff;`
                    }, {}, {})}
			...
			${validate_component(TimelineContent, "TimelineContent").$$render($$result, {}, {}, {
                  default: () => {
                    return `<h3 class="${"content-title svelte-1m5pl1e"}">${escape(item.title)}</h3>
				<div><img class="${"content-img svelte-1m5pl1e"}"${add_attribute("src", `images/activity/${item.imgSrc}`, 0)}${add_attribute("alt", item.title, 0)}></div>
				<p class="${"content-description svelte-1m5pl1e"}">${escape(item.description)}</p>
			`;
                  }
                })}
		`;
...
__export(__exports3, {
  ...
  index: () => index3,
  js: () => js3,
  module: () => activity_svelte_exports
});
var index3, entry3, js3, css5;
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_activity_svelte();
    index3 = 2;
    entry3 = "pages/activity.svelte-0ff14202.js";
    js3 = ["pages/activity.svelte-0ff14202.js", "chunks/index-c16f7798.js"];
    css5 = ["assets/pages/activity.svelte-5138ee04.css"];
  }
});
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["favicon.png", "images/activity/1_1-icpc-1.jpg", "images/activity/1_1-icpc.jpeg", "images/activity/1_2-nsc.jpg", "images/activity/1_3-GCCE-1.JPG", "images/activity/1_3-GCCE-2.JPG", "images/activity/1_3-GCCE.jpg", "images/activity/1_4-MOD-1.jpg", "images/activity/1_4-MOD.jpg", "images/activity/1_5-RaspPi-1.jpg", "images/activity/1_5-RaspPi.jpeg", "images/activity/2_1-icpc.jpg", "images/activity/2_2-nsc.jpg", "images/activity/2_3-MOD-1.jpg", "images/activity/2_3-MOD-2.jpg", "images/activity/2_3-MOD.jpg", "images/activity/3_1-hpcai.jpg", "images/activity/3_2-nsc.jpg", "images/activity/3_3-aucc.jpg", "images/activity/4_1-TMLCC-1.jpg", "images/activity/4_1-TMLCC-2.png", "images/activity/4_1-TMLCC.jpg", "images/activity/4_2-tr-expo-1.png", "images/activity/4_2-tr-expo-2.jpg", "images/activity/4_2-tr-expo.jpg", "images/activity/4_3-hpcai-1.JPG", "images/activity/4_3-hpcai-2.JPG", "images/activity/4_3-hpcai-3.JPG", "images/activity/4_3-hpcai.jpg", "images/activity/4_4-nsc.jpg", "images/avatar/p1.webp"]),
  mimeTypes: { ".png": "image/png", ".jpg": "image/jpeg", ".jpeg": "image/jpeg", ".JPG": "image/jpeg", ".webp": "image/webp" },
  _: {
    entry: { "file": "start-625355b4.js", "js": ["start-625355b4.js", "chunks/index-c16f7798.js"], "css": [] },
    nodes: [
